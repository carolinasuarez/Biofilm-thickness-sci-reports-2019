...
knit: (function(input_file, encoding) {
 ...
 encoding=encoding,
 output_file=file.path(dirname(input_file), out_dir, 'Beta_diversity.html'))})
output:
  html_document:
    df_print: paged
---
...
caro.ord.PCoA <- function(Source=dr, Distance.matrix) {
  ...
  theme(panel.border = element_rect(colour = "black"),
        ...
        axis.title = element_blank(), #For publication I uncomment this one
        axis.text.x = element_blank(), #For publication I uncomment this one
        axis.text.y = element_blank(), #For publication I uncomment this one
        legend.title = element_blank(),
